...
-- GÃ©nÃ©rÃ© le : mer. 17 juin 2026 Ã  12:31
...
--
-- DÃ©chargement des donnÃ©es de la table `configuration_hopital`
--
...
(1, 'CMA de Tyo', 'EntrÃ©e domicile Tankou', '694319623', 'cmatyo@gmail.com', 'public/uploads/hopital/logo_1780515899.jpg', 1, '2026-06-03 14:50:03', '2026-06-03 20:44:59');
...
CREATE TABLE IF NOT EXISTS `consultations` (
  ...
  `heure_pause` datetime DEFAULT NULL COMMENT 'Heure de mise en pause (dÃ©part pour examen externe)',
  `motif_pause` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Motif de la pause (ex: Radio, Analyse sanguineâ€¦)',
  `duree_pause_cumulee` int UNSIGNED NOT NULL DEFAULT '0' COMMENT 'DurÃ©e totale cumulÃ©e des pauses en secondes',
  `priorite_retour` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'PrioritÃ© absolue au retour d''examen externe',
  ...
  `prochain_rdv_id` int UNSIGNED DEFAULT NULL COMMENT 'ID de la consultation de suivi planifiÃ©e par le mÃ©decin',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Consultations des patients (remplace rendez_vous)';
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Planning journalier des sous-services par mÃ©decin';

--
-- DÃ©chargement des donnÃ©es de la table `emplois_du_temps`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Agents de gestion â€” chacun affectÃ© Ã  un sous-service';
...
CREATE TABLE IF NOT EXISTS `gestionnaire_jours_travail` (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `gestionnaire_id` int UNSIGNED NOT NULL,
  `jour_semaine` tinyint UNSIGNED NOT NULL COMMENT '1=Lundi Ã  7=Dimanche',
...
--
-- DÃ©chargement des donnÃ©es de la table `gestionnaire_jours_travail`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Historique des durÃ©es rÃ©elles â€” base du recalcul nocturne';
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='MÃ©decins intervenant dans les sous-services';
...
(2, 'MAGLOIRE', 'Ebele', 'HÃ©matologie', '677889900', 'ebelemagloire@gmail.com', '$2y$10$oKdZTF726kgSu2G2fFlvSOASyyrAOcefyhGzS8SH3xTC610TzzNPS', 'disponible', NULL, '2026-06-16 19:34:26');
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Jours de travail des mÃ©decins';

--
-- DÃ©chargement des donnÃ©es de la table `medecin_jours_travail`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Patients / usagers du systÃ¨me';
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='QR codes gÃ©nÃ©rÃ©s pour les sous-services';
...
(1, 'CMA Tyo de Baleng', 'Centre MÃ©dical d\'Arrondissement', 'PMI, entrÃ©e Ã©cole normale', '08:00:00', '18:00:00', NULL, NULL, '', NULL, 'actif', '2026-06-04 11:54:36');
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='DÃ©partements mÃ©dicaux (HÃ©matologie, Oncologieâ€¦) â€” niveau QR Code';
...
(3, 1, 'Cardiologie', 'Pour tout problÃ¨me liÃ© au coeur, consultez le service de cardiologie', 1800, 1800, 10, NULL, NULL, 'actif', '2026-06-04 11:54:36'),
(4, 1, 'HÃ©matologie', 'Pour les problÃ¨mes liÃ©s au sang', 1800, 1800, 2, NULL, NULL, 'actif', '2026-06-16 19:27:25');
...
(1, 'ebelemagloire@gmail.com', 'Dr Ebele Magloire', '$2y$10$81j7JUKeiB4rzCNlyy5J5ubwvbuwQR3gRf9fNP73P.5S0apOk3Nfa', 'admin', 2, NULL, 'actif', '2026-06-17 13:25:56', '2026-06-03 13:50:03', NULL),
(2, 'mathildemoumi@gmail.com', 'MOUMI MATHILDE', '$2y$10$.2Mi3klTmw5xVzFvxU4H8.3a/r9OZeb4VmsKAY0qkhwXHCxiwHesG', 'medecin', 1, NULL, 'actif', '2026-06-17 13:21:02', '2026-06-04 10:56:31', NULL),
(3, 'angezutchi@gmail.com', 'ange zutchi', '$2y$10$gm7ASaNRH2VuHd9MPXsN..6IrXz6j8slmMZ2dwUPr6AWK0W1vK2Au', 'gestionnaire', NULL, 1, 'actif', '2026-06-17 13:06:46', '2026-06-04 11:25:18', NULL);
...
CREATE EVENT `event_absence_auto` ON SCHEDULE EVERY 1 MINUTE STARTS '2026-06-08 11:05:50' ON COMPLETION PRESERVE ENABLE DO BEGIN

  -- Cas 1 : patient en_attente ou confirme non dÃ©marrÃ©
  --         10 minutes aprÃ¨s la fin de la consultation prÃ©cÃ©dente â†’ absent
  ...
  -- Cas 2 : patient en_pause depuis plus de 30 minutes â†’ absent
